...
for s in stocks:
	...
	print(str(data["Global Quote"]["01. symbol"]), "Price:", str(data["Global Quote"]["05. price"]), "High:", str(data["Global Quote"]["03. high"]), "Low:", str(data["Global Quote"]["04. low"]), "Change:", str(data["Global Quote"]["10. change percent"]))
